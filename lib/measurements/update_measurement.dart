...
class UpdateMeasurementOrderPage extends StatefulWidget {
  ...
  UpdateMeasurementOrderPage(this.isUpdate,this.document, this.index, {super.key});
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: RotatedBox(
                                      quarterTurns: 1, child: PaintPage2(isHorizontal: true,oldDrawing: widget.isUpdate ? drawingHorizontal : "",)),
                                ),
                              ],
                            ),
                          ),
  ...
  void update(String id) async {
    ...
    try {
      ...
      AddMeasurementsModel addMeasurementsModel = AddMeasurementsModel(
          ...
          drawingHorizontal: Provider.of<MyModel>(context, listen: false).drawingHorizontalData,
          // Include image URL
          );
